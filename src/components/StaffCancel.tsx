...
const StaffCancel = ({ isOpen, onClose, appointment, onConfirm }: StaffCancelProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="staff-cancel-modal-title">
      <div 
      ...
      >
        <div className="bg-linear-to-r from-red-500 to-red-600 px-6 py-4">
          <div className="flex items-center justify-between">
            <h3 id="staff-cancel-modal-title" className="text-2xl font-bold text-white flex items-center gap-2">
        ...
        <div className="px-6 py-6">
          <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className="space-y-1 text-sm">
              ...
              <p className="text-gray-600">
                <span className="font-medium text-gray-900">Email:</span> {appointment.email}
              </p>
              <p className="text-gray-600">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="p-4 bg-red-50 border border-red-200 rounded-lg" role="alert">
              <div className="flex gap-2">
                ...
                <div>
                  <h5 className="text-sm font-medium text-red-800 mb-1">Important Notice</h5>
                  <p className="text-sm text-red-700">
                    This action will cancel the appointment and send an email notification to the patient. 
                    The patient will need to book a new appointment if they wish to reschedule.
                  </p>
                </div>
              </div>
            </div>
